...
public class DateAndTime_04_Test {
    ...
    public void test_localDateTime_parse() {
        ...
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd MMMM yyyy 'à' hh'h'mm'm'ss's'", Locale.FRANCE);

        LocalDateTime result = LocalDateTime.parse("02 mars 2009 à 09h30m00s", formatter);
        //LocalDateTime result = LocalDateTime.from(localDate);
